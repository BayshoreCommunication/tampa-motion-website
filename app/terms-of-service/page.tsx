          ...
          <div className="text-center md:text-left text-md md:text-xl">
            ...
            <div className="flex flex-col  pt-5 pb-10">
              ...
              <p className="text-base text-stone-950  text-left pb-5">
                Tampa Motion offers physical therapy and rehabilitation
                services, focusing on personalized care to enhance mobility,
                manage pain, and improve your overall quality of life. Our
                expert therapists use evidence-based methods to support your
                recovery journey.
              </p>
              ...
              <ol className="pl-14 list-disc  pb-5  ">
                <li className="pb-4 text-base">
                  <span className="font-semibold">Booking: </span>Appointments
                  can be scheduled through our website, phone, or email.
                </li>
                <li className="pb-4 text-base">
                  <span className="font-semibold">Cancellations: </span>We
                  kindly request 24 hours notice for appointment cancellations
                  or rescheduling. Missed appointments without notice may incur
                  a cancellation fee.
                </li>
                <li className="pb-4 text-base">
              ...
              <p className="text-base text-stone-950  pb-5  text-left ">
                ...
                medication. Our physical therapy services complement your
                overall healthcare plan and should not replace advice from your
              ...
              <ol className="pl-14 list-disc  pb-5 ">
                ...
                <li className="pb-4 text-base">
                  ...
                  convenience. Tampa Motion is not responsible for the content
              ...
              <p className="text-base text-stone-950  pb-5  text-left ">
                We respect your privacy. All client information shared with
                Tampa Motion is kept confidential and used solely for treatment
              ...
              <p className="text-base text-stone-950   pb-5 text-left ">
                Tampa Motion respects intellectual property rights. If you
                believe your copyrighted material has been used improperly,
                please contact us with the relevant details so we can address
                the issue promptly.
              </p>
              <p className="text-base  pb-3 md:text-2xl text-stone-950 text-left font-semibold">
              ...
              <p className="text-base text-stone-950   pb-5 text-left ">
                Tampa Motion reserves the right to modify, suspend, or
                discontinue its services at any time, without prior notice. We
                are not liable for any interruptions or changes that may affect
              ...
              <p className="text-base text-stone-950   pb-5 text-left ">
                Tampa Motion may retain data related to your use of the
                services. While we take measures to protect your data, you are
                responsible for ensuring the security of any information you
                transmit to us.
              </p>
              <p className="text-base  pb-3 md:text-2xl text-stone-950 text-left font-semibold">
                CONTACT US{" "}
