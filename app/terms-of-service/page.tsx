      ...
      <article className="container">
        <div className="text-center md:text-left text-md md:text-xl">
          ...
          <div className="flex flex-col  pt-5 pb-10">
            <p className="text-lg  pb-3 md:text-2xl text-stone-950 text-left font-semibold">
              Services Provided
            </p>
            <p className="text-lg text-stone-950  text-left pb-5">
            ...
            <p className="text-lg md:text-2xl text-stone-950 pb-3 text-left font-semibold">
            ...
            <p className="text-lg text-stone-950  pb-5  text-left ">
