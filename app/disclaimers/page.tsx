            ...
            <ol className="pl-14 list-disc pb-10 text-2xl">
              <li className="pb-6">
                ...
                <p className="text-lg text-stone-950  text-left ">
                  ...
                  to inquiries. By providing your contact information, you
                  confirm that you are authorized to receive such
                  communications.
                </p>
              </li>
              <li className="pb-6">
                ...
                <p className="text-lg text-stone-950  text-left ">
                  ...
                  information on this site is not a substitute for professional
                  consultation with a licensed physiotherapist or healthcare
                  provider. Always consult with a qualified professional for any
                  medical concerns or decisions regarding your health and
                  treatment.
                </p>
              </li>
              <li className="pb-6">
                ...
                <p className="text-lg text-stone-950  text-left ">
                  ...
                  Continued use of the site constitutes your acceptance of these
                  terms. If any part of these terms is found to be invalid or
              ...
              <li className="pb-6">
                ...
                <p className="text-lg text-stone-950  text-left ">
                  ...
                  license to use this website solely for personal purposes. You
                  may not reproduce, distribute, or use the content for
              ...
              <li className="pb-6">
                ...
                <p className="text-lg text-stone-950  text-left ">
                  ...
                  completeness, accuracy, or functionality of the website. Tampa
                  Motion, PLLC is not liable for any damages resulting from your
