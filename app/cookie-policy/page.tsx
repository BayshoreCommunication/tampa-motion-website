          ...
          <div className="text-center md:text-left text-md md:text-xl">
            <div className="my-2">
              ...
              <p className=" text-base text-stone-950 text-center md:text-left pb-5">
                ...
                cookies in accordance with this Cookie Policy. This Cookie
                Policy explains how cookies are used, the role of third parties,
                your options for managing cookies, and how to control their
                usage effectively.
              </p>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                ...
                visit a website. These files help websites remember details
                about your visit, making future visits more efficient and
                personalized. Cookies can be "persistent" (remaining in your
                browser after you leave the site) or "session" cookies (deleted
              ...
              <ol className="pl-14 list-disc">
                ...
                <li className="pb-4 text-base">
                  ...
                  We use cookies to gather data on how visitors use our site,
                  such as which pages are visited most often or if any errors
                  occur. This information helps us improve the site’s
                  functionality.
                </li>
                <li className="pb-4 text-base">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                ...
                deleting existing cookies or refusing new ones. However,
