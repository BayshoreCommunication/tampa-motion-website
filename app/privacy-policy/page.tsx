          ...
          <div className="text-center md:text-left text-md md:text-xl">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                ...
                ("TOS") of this website are incorporated into and form an
                integral part of this policy. By using our website or services,
                you acknowledge and accept the terms of this Privacy Policy. If
                you do not agree, please refrain from using our website or
                services.{" "}
              </p>
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                ...
                the best possible experience. In addition, we collect and
                maintain this information to ensure you with accurate services.
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                This includes data that identifies or can be used to identify
                you, such as:
              </p>
              ...
              <ol className="pl-14 list-disc">
                ...
                <li className="pb-4 text-base">
                  ...
                  Small data files to enhance user experience and analytics.
                  Such as{" "}
                  <span className="text-blue-500 underline">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                We do not share, lease, or exchange your personal information
                for commercial purposes However, we may share your data in the
              ...
              <ol className="pl-14   list-disc">
                <li className="pb-4 text-base">
                  ...
                  needed to coordinate your treatment and ensure appropriate
                  care.{" "}
                </li>
                <li className="pb-4 text-base">
                  <span className="font-semibold">
                ...
                <li className="pb-4 text-base">
                  ...
                  In the event of a merger, acquisition, or sale of Tampa
                  Motion, PLLC, your data may be transferred as part of the
                  transition.{" "}
                </li>
              </ol>
              <p className="text-base md:text-2xl text-stone-950 text-center md:text-left font-semibold">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                Despite our efforts, no security system is{" "}
                <strong>100% </strong>
              ...
              <ol className="pl-14  list-disc">
                ...
                <li className="pb-4 text-base">
                  ...
                  If any of your details are incorrect or incomplete, you may
                  ask us to update or amend them.
                </li>
                <li className="pb-4 text-base">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                ...
                own privacy policies, so we recommend checking those out
                directly.
              </p>
              <p className="text-base md:text-2xl text-stone-950 text-center md:text-left font-semibold">
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                ...
                data from a child under <strong>13</strong>, we will delete it
                promptly. If you believe we may have information about a child
                under <strong>13</strong>, please notify us at{" "}
                <span className="text-blue-500 underline">
                  <Link href="mailto:athena.akram@tampamotion.com">
                    athena.akram@tampamotion.com
                  </Link>
              ...
              <p className="text-base text-stone-950 text-center md:text-left">
                We may revise this Privacy Policy from time to time to align
                with changes in our practices or legal obligations. Any
                modifications or updates will be posted on this page with an
