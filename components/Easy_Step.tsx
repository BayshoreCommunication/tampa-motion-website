...
const Easy_Step = () => {
  return (
    <section className="bg-white px-10 h-fit inline-grid grid-flow-row grid-cols-1 auto-rows-min pb-16 w-full content-center">
      <div className="col-span-1 text-2xl font-baskerville p-8 text-textSecondary text-center leading-normal">
        Easy Step to Get Physiotherapy
      </div>
      <ol className="col-span-1 relative border-s border-primary text-textSecondary pl-6 ml-2 h-fit m-auto w-full ">
        <li className="mb-10 ms-6" key={1}>
          ...
          <h3 className="flex items-center mb-1 text-base font-baskerville ">
            Make an Appointment
          </h3>
