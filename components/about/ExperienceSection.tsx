      ...
      <div className="container py-10 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center justify-between mt-10 md:mt-20">
          <div className="flex items-center justify-center border bg-white shadow-xl p-10 space-x-6 rounded-lg">
            ...
            />
            <div className="">
              <h2 className="text-4xl md:text-4xl font-semibold black">100</h2>
          ...
          <div className="flex items-center justify-center border bg-white shadow-xl p-10 space-x-6 rounded-lg">
            ...
            />
            <div className="">
              <h2 className="text-4xl md:text-4xl font-semibold black">880</h2>
          ...
          <div className="flex items-center justify-center border bg-white shadow-xl p-10 space-x-6 rounded-lg">
            ...
            />
            <div className="">
              <h2 className="text-4xl md:text-4xl font-semibold black">640</h2>
