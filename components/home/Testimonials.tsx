  ...
  return (
    <div className="bg-doctors bg-cover text-black ">
      <ScrollMotionEffect effect="fade-right" duration={2000}>
        <section className="px-5 inline-grid grid-flow-row auto-rows-min grid-cols-1 py-10 md:py-20  bg-doctors  ">
          <div className="col-span-1">
            ...
            <h4 className="font-sans py-3 text-black text-center md:py-5 lg:py-8 px-5 lg:px-20 2xl:px-52">
              ...
              beatae porro eaque quisquam! Ducimus. Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Itaque deleniti sapiente, labore
              asperiores quod ullam voluptatem delectus, quam iure veritatis
              blanditiis maiores quos ut? Reprehenderit voluptate assumenda
              temporibus adipisci cum.
            </h4>
          </div>
